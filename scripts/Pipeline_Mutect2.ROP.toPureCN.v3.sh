...
#COMANDO: Pipeline_Mutect2.ROP.toPureCN.v2.sh /path/samples.list /home/scratch60/
...
# --interval-padding 50 \
# ATUALIZAÇÃO:
# /home/users/vlira/PanelOfNornal/PON_ToPureCN/PON_Mutect2/, PON específico para o pureCN, nele foi usado a target baits_optimized_hg38.bed
# O arquivo baits_optimized_hg38.bed foi gerado pelo script $PURECN/IntervalFile.R do pureCN
# TARGET="$SCRATCH60/PureCN_Docker/reference_files/baits_optimized_hg38.bed"
# Executando o pipeline ate a etapa "left_normalization"
...
export MEM=200
export JOBS=5
>>>>>>> 71aaefeac73d7d9aab4ca211edc1da0953494c69
...
#export GATK="gatk"
export TARGET="$SCRATCH60/PureCN_Docker/reference_files/baits_optimized_hg38.bed"
